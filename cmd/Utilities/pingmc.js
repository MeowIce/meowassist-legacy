...
const commandBase = {
	...
	callback: async ({ interaction, client, guild, member, user, options }) => {
        ...
        const embed = new MessageEmbed()
            ...
            .addField(`Có IP trong SRV`, data.debug.ipinsrv?.toString() || "Không biết", true)
            .addField(`Có CNAME trong SRV`, data.debug.cnameinsrv?.toString() || "Không biết", true)
            .addField(`Phiên bản máy chủ`, data.version?.toString() || "Không biết", true)
